...
export async function fetchFollowingPosts() {
    const config = getConfig()
    try {
        return await axios.get(vercelAPI.concat('/api/post/following-posts'), config)
    } catch (error) {
        console.error(error)
    }
}
...
export async function fecthExplorePosts() {
    const config = getConfig()
    try {
        return await axios.get(vercelAPI.concat('/api/post/discover-posts'), config)
    } catch (error) {
        console.error(error)
    }
}
...
export async function toggleLike (variables) {
    ...
    try {
        return await axios.put(vercelAPI.concat(`/api/post/like/${variables.post.id}`), { meId: variables.user.id, mode: isliked? "unlike" : "like" }, getConfig())
...
export async function postImageFromUrl(url,title, subtitle) {
    ...
    try {
        ...
        return await axios.post(vercelAPI.concat("/api/post/image-url"), {title, subtitle, imagePost:url, type: 'image'}, config)
    } catch(error) {
        console.error(error)
    }
...
export async function postImageFromFile(file, title, subtitle) {
    ...
    try {
        ...
        return await axios.post(renderAPI.concat("/api/post/image-file"), formData, config)
    } catch(error) {
        console.error(error)
    }
}
...
export async function postVideoFromUrl(url, title, subtitle, aspectRatio) {
    ...
    try {
        ...
        return await axios.post(vercelAPI.concat("/api/post/video-url"), {title, subtitle, videoPost:url, videoAr: aspectRatio, type: 'video'}, config)
    } catch(error) {
        console.error(error)
    }
}
...
export async function postVideoFromFile(file, title, subtitle, ) {
    ...
    try {
        ...
        return await axios.post(renderAPI.concat("/api/post/video-file"), formData, config)
    } catch(error) {
        console.error(error)
    } 
...
export async function postText(title, text) {
    ...
    try {
        ...
        return await axios.post(vercelAPI.concat("/api/post"), {title, textPost: text, type: 'text'}, config)
    } catch(error) {
        console.error(error)
    }
}
...
export async function postQuote(author, work, quote) {
    ...
    try {
        ...
        return await axios.post(vercelAPI.concat("/api/post"), {title: author, subtitle: work, textPost: quote, type: 'cita'}, config)
    } catch(error) {
        console.error(error)
    }
